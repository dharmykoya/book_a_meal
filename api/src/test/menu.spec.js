    ...
    it('should add menus for the day', (done) => {
      request(app)
        ...
        .expect((res) => {
          ...
          expect(res.body.createdMenu.message).toBe('Menu set successfully');
          expect(res.body.createdMenu.createdMenu).toBeA('object');
        })
        .end(done);
    });
  });
  ...
  describe('Get All Menus ', () => {
    it('should return all menu', (done) => {
      request(app)
        ...
        .expect((res) => {
          expect(res.body).toBeA('object');
          expect(res.body.foundMenu).toBeA('object');
          expect(res.body.foundMenu.menuMeal).toBeA('object');
